...
public class ZoomImageView extends ImageView implements ViewTreeObserver.OnGlobalLayoutListener
    ...
    private IvOnClickListener shortClickListener;

    public interface IvOnClickListener {
        void onClick();
    }

    public void setShortClickListener(IvOnClickListener listener) {
        this.shortClickListener = listener;
    }

    private IvOnLongClickListener longClickListener;

    public interface IvOnLongClickListener {
        void onLongClick();
    }

    public void setLongClickListener(IvOnLongClickListener listener) {
